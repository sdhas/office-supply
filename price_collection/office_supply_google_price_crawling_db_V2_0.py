...
STRIKE_IO_API_GET_OPEN_INPUT_URL = f"{STRIKE_IO_API_BASE_URL}/inputs?client={CLIENT}&type=OPEN&count=1&reportDate=<report-date>&reportTime=<report-time>"
